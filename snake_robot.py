...
class SnakeRobot:
    ...
    def get_imu_data(self, dt, add_noise=False, debug=False):
        ...
        if debug:
            draw_line(self.debug_items, "head_imu_accel", body_world_position, body_world_position + lin_acc_world, [1, 1, 0])
        ...
        for link_idx in range(num_child_links):
            ...
            # lin_acc
            if debug:
                draw_line(self.debug_items, f"{link_idx}_imu_accel", link_world_position, link_world_position + lin_acc_world, [1, 1, 0])
